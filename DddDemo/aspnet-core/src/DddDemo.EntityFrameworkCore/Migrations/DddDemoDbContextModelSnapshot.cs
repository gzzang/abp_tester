...
{
    [DbContext(typeof(DddDemoDbContext))]
    partial class DddDemoDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DddDemo.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DddDemo.Orders.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DddDemo.Orders.Order", b =>
                {
                    b.OwnsOne("DddDemo.Orders.Address", "ShippingAddress", b1 =>
                        {
            ...
            modelBuilder.Entity("DddDemo.Orders.OrderItem", b =>
                {
                    b.HasOne("DddDemo.Orders.Order", null)
                        .WithMany("Items")
                        .HasForeignKey("OrderId")
